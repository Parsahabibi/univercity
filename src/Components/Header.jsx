...
const Header = ({ title, subTitle, image, active }) => {
    ...
    return (
        <div className='w-full pt-[72px] pb-[200px] max-h-[530px] bg-cover bg-left mb-16' style={{ backgroundImage: "url('./assets/images/svg/blog.svg')" }}>
            ...
            <div className='w-4/5 mx-auto max-w-[1250px]'>
                <h1 className='text-4xl xl:text-5xl text-black font-bold mb-4'>انجمن علمی مهندسی کامپیوتر</h1>
                {
                    subTitle !== '' &&
                    <span className='text-xl xl:text-3xl text-black'>کدنویسی، نوآوری، آینده</span>
                }
            </div>
        </div>
    );
